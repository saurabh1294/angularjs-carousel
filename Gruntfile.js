  ...
  grunt.initConfig({
    ...
    concat: {
      devjs: {
          ...
          dest: 'dist/dev/carousel.component.js'
      },
      devcss: {
        // the files to concatenate
        src: ['src/**/*.css'],
        // the location of the resulting JS file
        dest: 'dist/dev/carousel.component.css'
      }
    },
    uglify: {
      prodjs: {
        src : ['src/**/*.js'],
        dest : 'dist/prod/carousel.component.min.js'
      }
    },
    cssmin: {
      prod: {
          files: {
            'dist/prod/carousel.component.min.css': ['src/**/*.css']
          }
      }
    },
    sass: {
